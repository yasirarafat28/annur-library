    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                <!-- /.box-header -->
                <div class="box-body">
                    <a href="#" class="btn btn-primary pull-right" id="category_add"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;ADD CATEGORY</a>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a  class="btn btn-primary mr-2 category_edit" data-id="<?php echo $row['category_id']?>" ><i class="fa fa-wrench" aria-hidden="true"></i> &nbsp;&nbsp;&nbsp;Edit</a>
                                        <a  class="btn btn-danger category_delete" data-id="<?php echo $row['category_id']?>" id="category_delete"><i class="fa fa-trash" aria-hidden="true"></i> &nbsp;&nbsp;&nbsp;Delete</a>  
                                    </td>
...
<script>
    ...
    var categoryAddFormUrl='<?php echo base_url()?>index.php/category/category_form';
    /*
