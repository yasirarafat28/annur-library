    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <?php foreach ($edit_data as $row) { ?>
                <?php
                    echo form_open(base_url() . 'index.php/basic_setup/menu5_background_update/', array(
                        'class' => 'form-horizontal',
                        'method' => 'post',
                        'id' => 'menu5_background_editer',
                            ...
                            <div class="row">
                                <div class="col-sm-5 col-sm-offset-6">
                                    <span class="pull-left btn btn-default btn-file ml-40">
                                        ...
                                        <input type="file" name="menu5_back" class="form-control" id="imgInp">
                                    </span>
                                </div>
                            </div>
                        </div>
    ...
    $(document).ready(function () {
         ...
         */
            $('.sub').on('click', function () {
                var redirectUrl='<?php echo base_url()?>index.php/basic_setup/menu5_background';
                    editFormSubmit('menu5_background_editer',redirectUrl);
