        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box box-info">
                    ...
                    <?php
                    echo form_open(base_url() . 'index.php/basic_setup/sol_add/', array(
...
<script>
    $(document).ready(function () {
        ...
        $('.sub').on('click', function () {
            var redirectUrl = '<?php echo base_url() ?>index.php/basic_setup/sol/';
            addFormSubmit('sol_editer', redirectUrl);
        });
