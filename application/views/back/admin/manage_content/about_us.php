        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box box-info">
                    ...
                    <?php
                    echo form_open(base_url() . 'index.php/manage_content/update_about_us/', array(
                    ...
                    <?php foreach ($edit_data as $row) { ?>
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control " name="about_name"  id="aboutUs_name" value="<?php echo $row['title']; ?>">
    ...
    $(document).ready(function () {
        ...
        $('.sub').on('click', function () {
            if (about_name_error === false) {
                var redirectUrl = '<?php echo base_url() ?>index.php/manage_content/update_about_us/';
