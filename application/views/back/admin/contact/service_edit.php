    ...
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <?php foreach ($edit_data as $row) { ?>
                <?php
                    echo form_open(base_url() . 'index.php/service/service_update/' . $row['service_id'], array(
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control " name="name"  id="service_name" value="<?php echo $row['service_name']; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea rows="9" class="summernotes" data-height="300" data-name="description"><?php echo $row['service_desc']; ?></textarea>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
         ...
         */
            var service_name_error=checkInput('service_name','title');
        /*
         * Submit Edit Form
         */
            $('.sub').on('click', function () {
                ...
                if (service_name_error === false) {
                    editFormSubmit('service_editer',redirectUrl);
                }
