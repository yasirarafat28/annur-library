...
<div class="container">
	...
	?>           
		<h3 style="text-align:center;background-color: #895621; padding: 5px 8px 5px 8px;color: #fff;font-size: 16px; " ><?php echo $row['publisher_name']?></h3>
		...
		<div class="col-md-12" style=" margin-left: auto; margin-right: auto;">
			...
			<p><?php echo $row['publisher_overview'];?></p>
			<p><?php echo 'ঠিকানা : '.$row['publisher_address'];?></p>
		</div>
	<?php
		}
	?>
