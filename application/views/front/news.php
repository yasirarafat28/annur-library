		...
		?>
			<div style="margin-top:20px;">
				...
				<div style="float: right;width: 70%;padding-left: 3%;">
					...
					<p ><a href="<?php echo base_url(); ?>index.php/home/news_detail/<?php echo $row['post_id']?>" style="background-color: #895621;padding: 0px 8px 0px 8px;color: #fff;float: right; border-radius: 3px;" >বিস্তারিত</a></p>
				</div>
			</div>
