<section class="ContentPageOddEvenSection margintop" style="padding-left: 10px; margin: 50px 0 0 0 !important" itemscope>
		<h3 style="text-align: center;background-color: #895621;color: #fff;padding-top: 2px;padding-bottom:2px;">সাহিত্য ও সংস্কৃতি  </h3>
    <div class="container">
		...
		?>
			...
			<div style="margin-top:20px;">
				...
				<div style="float: right;width: 70%;padding: 0% 3% 0% 3%;">
					...
					<p ><a href="<?php echo base_url()?>index.php/home/lit_and_culture_detail/<?php echo $row['post_id']?>" style="background-color: #895621;padding: 0px 8px 0px 8px;color: #fff;float: right; border-radius: 3px;" >বিস্তারিত</a></p>
				</div>
			</div>
